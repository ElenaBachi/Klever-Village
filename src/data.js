...
export const activities = [
  ...
  },
  {
    ...
    text: "С собой берем отличное настроение и одежду, подходящую для водных брызг! Едем на самый красивый берег Финского залива или Копанского озера и наслаждаемся красотой природы, попутным ветром и нежным солнышком!",
    imgSrc: BoatSrc,
  },
];
