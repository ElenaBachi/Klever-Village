...
export const cafe = {
  menu: [
    {
      title: "Завтрак",
      price: "включен в проживание",
    },
    {
      title: "Завтрак (гости со стороны)",
      price: "1000 ₽",
    },
    {
      title: "Обед",
      price: "700 ₽",
      note: [
        "по предзаказу или если есть доп порции",
  ...
  extras: [
    ...
    { title: "Чай", price: "100 ₽" },
    { title: "Выпечка", price: "стоимость по согласованию" },
  ],
  workingHours: [
    {
      title: "Завтрак",
      description: [
        "с 7.00 до 9.00 будни",
        " с 7.00 до 10.00 выходные",
        "Время работы в будни может меняться до 10.00, если есть гости по отдыху.( на усмотрение администрации)",
      ],
    },
    {
      title: "Обед",
